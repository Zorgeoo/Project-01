...
export const SecondSection = () => {
  return (
    <div className="bg-gray-50 dark:bg-[#111827]">
      <div className="max-w-screen-lg  lg:w-[600px] m-auto lg:px-[400px]">
            ...
            <div className="flex px-[32px] py-[50px] lg:flex-col gap-[48px]">
              ...
              <div className="flex-1 flex flex-col justify-evenly ">
                ...
                <div>
                  ...
                  Now in my early thirties, seven years in, I am building
                ...
                <div>
                  One last thing, I am available for freelance work, so feel
                  free to reach out and say hello! I promise I do not bite 😉
                </div>
              </div>
            </div>
          </div>
